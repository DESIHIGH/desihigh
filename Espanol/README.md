...
:rotating_light:  Estamos casi listos para empezar. Primero verás una página de carga, después de la cual querrá Espanol/Intro_es.ipynb y luego Espanol/DESI_es.ipynb. En esa etapa, serás un profesional y podrás probar el resto: SnowWhiteDwarf es uno de nuestros favoritos. Ok, wapara ello, [IR](https://mybinder.org/v2/gh/michaelJwilson/DESI-HighSchool/master)! :rotating_light:
