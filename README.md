...
:whale:  For budding developers, we support [Travis](https://travis-ci.com/github/michaelJwilson/DESI-HighSchool), [Docker](https://hub.docker.com/r/mjwilsonlbl/desihigh) and [Anaconda Cloud](https://anaconda.org/michaeljwilson/desi-high) for budding developers. :cloud: 
